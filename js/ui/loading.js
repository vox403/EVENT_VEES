(() => {
  ...
  const stages = [
    ...
    { at: 100, image: "assets/2-3.png", status: "CONNECTION ESTABLISHED" }
  ];
  ...
  function startLoading(onComplete) {
    ...
    const render = progress => {
      ...
      status.textContent = value >= 90 && value < 100 ? "SIGNAL STABILIZING" : stage.status;
      ...
      if (value >= 90 && value < 100 && !flickerStarted) {
        flickerStarted = true;
